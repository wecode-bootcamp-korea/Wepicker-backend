...
class Order_item(models.Model):
    ...
    option        = models.ForeignKey('product.Option', on_delete=models.CASCADE, null=True)
    delivery_cost = models.ForeignKey('Delivery_cost', on_delete=models.CASCADE)
...
class Order(models.Model):
    ...
    card           = models.ForeignKey('user.Card', on_delete=models.CASCADE, null=True)
    state          = models.ForeignKey('Order_state', on_delete=models.CASCADE)
